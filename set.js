...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~bvgi0B7I#G84BteAcn091azDoZHF0f9HRPvaQ8oFT-T7-Jra9vM0", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "254713145618", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NAME: process.env.OWNER_NAME || "Ongeri 💜💜", // Input Yours custom...(Maintain font for Flow)
